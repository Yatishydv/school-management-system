...
const StudentFees = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50/20 pb-40 relative overflow-hidden font-body">
            {/* Decal */}
            <div className="absolute top-20 left-[-10%] text-[20vw] font-black text-blue-950/[0.03] pointer-events-none select-none tracking-tighter uppercase whitespace-nowrap rotate-90">
                FINANCE
            </div>
